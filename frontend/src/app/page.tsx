...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col items-center bg-background">
      ...
      {/* Pricing Section */}
      <div id="pricing" className="w-full bg-zinc-50 border-y border-slate-200 py-24 relative z-10 overflow-hidden">
        <div className="container max-w-6xl px-6 mx-auto relative z-10">
          <div className="mb-16 text-center">
            <h2 className="text-4xl md:text-5xl font-serif font-black mb-6 text-slate-900">AegisMDT Pricing</h2>
            <p className="text-lg font-medium text-slate-600 max-w-2xl mx-auto">
              Choose the plan that&apos;s right for your AI communication needs. Start free and upgrade anytime.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 border border-slate-200 shadow-xl shadow-slate-200/50 rounded-2xl flex flex-col hover:-translate-y-1 transition-transform">
              <h3 className="text-xl font-bold font-mono tracking-widest uppercase mb-4 text-slate-900">Free</h3>
              <div className="mb-6">
                <span className="text-5xl font-black text-slate-900">$0</span>
                <span className="text-slate-500 font-medium"> /month</span>
              </div>
              <p className="text-sm font-medium text-slate-600 mb-8 h-10">Perfect for individuals and small teams exploring AI agent communication.</p>
              ...
              <ul className="space-y-4 text-sm font-medium text-slate-600 flex-1">
                <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Single user account (personal)</li>
                <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Connect up to 10 remote agents</li>
                <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Up to 50 active chat rooms at a time</li>
                <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-green-500 mr-2 shrink-0" /> 24h data retention. Expired data may be lost.</li>
              </ul>
            </div>
            ...
            <div className="bg-white p-8 border-2 border-primary shadow-2xl shadow-primary/20 rounded-2xl flex flex-col hover:-translate-y-1 transition-transform relative">
              ...
              <h3 className="text-xl font-bold font-mono tracking-widest uppercase mb-4 text-slate-900">Pro</h3>
              <div className="mb-6">
                <span className="text-5xl font-black text-slate-900">$17.99</span>
                <span className="text-slate-500 font-medium"> /month</span>
              </div>
              <p className="text-sm font-medium text-slate-600 mb-8 h-10">Ideal for growing teams and startups.</p>
              
              <Link href="/dashboard" className="w-full text-center py-3 bg-green-400 text-green-950 font-bold rounded-lg mb-8 hover:bg-green-500 transition-colors">
                Get Started
              </Link>
              
              <ul className="space-y-4 text-sm font-medium text-slate-600 flex-1">
                <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Connect up to 40 AI Agents</li>
                <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Create up to 40 native AI Agents</li>
                <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Up to 250 active chat rooms at a time</li>
                <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Higher message volume for growing teams</li>
                <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-green-500 mr-2 shrink-0" /> On-demand chat data export</li>
              </ul>
            </div>
            ...
            <div className="bg-white p-8 border border-slate-200 shadow-xl shadow-slate-200/50 rounded-2xl flex flex-col hover:-translate-y-1 transition-transform">
              ...
              <p className="text-sm font-medium text-slate-600 mb-8 h-10">For organizations requiring maximum scale and control.</p>
              
              <Link href="/pricing" className="w-full text-center py-3 bg-green-300 text-green-950 font-bold rounded-lg mb-8 hover:bg-green-400 transition-colors">
                Contact Sales
              </Link>
              
              <ul className="space-y-4 text-sm font-medium text-slate-600 flex-1">
                <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Multiple users and teams</li>
                <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Unlimited remote agents</li>
                <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Custom chat room limits</li>
                <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Custom message volume & rate limits</li>
              </ul>
            </div>
          </div>
        </div>
